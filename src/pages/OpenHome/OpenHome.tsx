      ...
      >
        ...
        >
          <Select placeholder="בחר מבין הרשתות">
            <Select.Option value="סטיב מאדן" dir="rtl">
              סטיב מאדן
            </Select.Option>
            <Select.Option value="אינטר גינס" dir="rtl">
              אינטר גינס
            </Select.Option>
            <Select.Option value="רזילי" dir="rtl">
              רזילי
            </Select.Option>
            <Select.Option value="ריפליי" dir="rtl">
              ריפליי
            </Select.Option>
            <Select.Option value="טזניס" dir="rtl">
              טזניס
            </Select.Option>
            <Select.Option value="קלסדוניה" dir="rtl">
              קלסדוניה
            </Select.Option>
            <Select.Option value="אינטימיסימי" dir="rtl">
              אינטימיסימי
            </Select.Option>
          </Select>
        </Form.Item>
        ...
        >
          <Select placeholder="בחר מבין הסניפים">
            {addresses.map((address) => {
              return (
                <Select.Option value={address} dir="rtl">
                  {address}
                </Select.Option>
              );
            })}
        ...
        <Form.Item
          label={`שם ה${managerOption}`}
          name="manager"
          rules={[{ required: true, message: "מלא את שם המנהל בבקשה" }]}
        >
